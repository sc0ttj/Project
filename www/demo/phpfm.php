...
if (count($users) == 0)
{
    $users = array('admin' => array('admin' => '1','password' => $valid_password,'root' => '.','access' => array('.' => 2)));
    if ($loginmethod == 2)
        $users = array('admin' => array('admin' => '1','password' => sha1($valid_password),'root' => '.','access' => array('.' => 2)));
